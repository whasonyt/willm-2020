...
def youtube_videos():
    YOUTUBE_API_URL = 'https://www.googleapis.com/youtube/v3/search?order=date&maxResults=9&part=snippet&channelId=UCA3QtGSDbBoS5ogCitr_KQw&key=' + os.environ.get('YOUTUBE_API_KEY')
